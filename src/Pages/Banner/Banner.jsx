    ...
    return (
        <div className='bg-gray-100'>
            ...
            <div className='text-center pt-20 mb-10'>
                ...
                <p className='text-gray-600 text-xl mt-8 mb-10 lg:px-50'>At HERO.IO , we craft innovative apps designed to make everyday life simpler, smarter, and more exciting.Our goal is to turn your ideas into digital experiences that truly make an impact.</p>
